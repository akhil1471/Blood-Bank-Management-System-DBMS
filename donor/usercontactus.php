<?php
 ...
 if(isset($_POST["submit"]))
 {
  ...
  $feedback_id=$donor->id;
  $rs=mysqli_query($con,"insert into donor_feedback (feedback_id, name,email,phone,message) VALUES ('$feedback_id', '$name','$email','$phone','$message')") or die(mysqli_error());
     	if($rs)
     	{
      ...
      <div class="contact">
        <form class="form1" method="post" style="box-shadow:4px 1px 20px black;">
          ...
          <div class="form-group">
            ...
            <input type="text" name="name" value=" <?php echo $donor->name; ?>"class="form-control" placeholder="Enter Name" disabled>
          </div>
            <div class="form-group">
              <label for="Email">Email</label>
              <input type="text" name="email" value=" <?php echo $donor->email; ?>"class="form-control" placeholder="Enter Email" disabled>
            </div>
              <div class="form-group">
                <label for="Phone">Phone</label>
                <input type="text" name="phone"value=" <?php echo $donor->phone; ?>" class="form-control" placeholder="Enter Phone" disabled>
              </div>
                <div class="form-group">
