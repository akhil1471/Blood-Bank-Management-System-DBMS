...
// if everything is ok, try to upload file
      ...
      }else
      {
        ...
        // {
            ...
            $rs=mysqli_query($con,"INSERT INTO donarregistration (name,gurdians_name,address,state,phone,email,gender,dob,age,bloodgroup,any_disease,occupation,password) VALUES ('$name','$gurdians_name','	$address','$state','$phone','$email','$gender','$dob','$age','$bloodgroup','$any_disease','$occupation','$password')") or die(mysqli_error($con));
           	if($rs)
           	{
