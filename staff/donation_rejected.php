<?php
 ...
 $sql = "SELECT * from donarregistration as donordetail INNER JOIN donateblood as donateblood  ON  donordetail.id  = donateblood.donarreg_id  WHERE status='rejected'";
